      ...
      <div className="domain-page">
        <div className="company-info">
          <div className="company-logo">
            <Image src={anonGroup.logoUrl} alt={anonGroup.title} width={50} height={50} />
          </div>
          <div>
            <div className="company-title">{anonGroup.title}</div>
            <div className="company-description">Anonymous messages from members of {anonGroup.title}</div>
          </div>
        </div>

        <MessageList groupId={groupId} showMessageForm={currentGroupId == groupId} />
      </div>
    </>
  );
}
