...
const ProveByEmail = (props: {
  ...
  return (
    <div>
      <p>
        You can anonymously prove that you are part of a company by proving you have received an{' '}
        <strong>internal company email</strong>.
      </p>

      {!emailContent && (
        <>
          <p>
            Download <strong>any</strong> email you received from &quot;someone@your-company.com&quot; and drop it here.
          </p>
          ...
          {!error && (
            <p>
              This will generate a cryptographic proof of the email and extract your company domain. This happens
              entirely in your browser and the <strong>email never leaves your device</strong>.
            </p>
          )}
        </>
      )}
      ...
      {emailContent && (
        <div>
          ...
          <button className="prove-modal-button" onClick={onSubmitClick} disabled={!!error}>
